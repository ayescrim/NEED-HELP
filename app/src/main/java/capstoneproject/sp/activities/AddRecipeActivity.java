...
// setting values of the variables
        ...
        //TRIAL BUTTON
        //============================================
        asd123 = (Button) findViewById(R.id.asd123);
        //============================================
        //============================================
...
//when button is clicked shit happens
        asd123.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), AnimalChoiceBeefActivity.class);
    ...
    protected void onStart() {
        ...
        databaseRecipes.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                RecipeListAdapter adapter = new RecipeListAdapter(AddRecipeActivity.this, recipeList);
